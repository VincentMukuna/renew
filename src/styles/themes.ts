...
function withBrandColors<T extends { status: typeof lightStatusColors | typeof darkStatusColors }>(
  ...
  return {
    ...
    status: {
      inactive: neutralColors.status.inactive,
      dueSoon: neutralColors.status.dueSoon,
      active: brand.statusActive,
    },
  };
}
...
/** Neutral shell plus the default indigo brand tokens. */
...
export const lightTheme = {
  ...
  colors: withBrandColors(neutralLightColors, "light"),
  spacing: {
    xs: 4,
    sm: 8,
    md: 16,
...
export const darkTheme: AppTheme = {
  ...lightTheme,
  name: "dark",
  colors: withBrandColors(neutralDarkColors, "dark"),
};
